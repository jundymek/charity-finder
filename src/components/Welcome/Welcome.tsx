...
function Welcome({ isVisible = true, setIsWelcomeVisible }: Props) {
  return (
    <section className={styles.container}>
      ...
      <p className={styles.paragraph}>This simple app allows you to search a list of global charities. Simply find a charity that matches your interests. <span role="img" aria-label="Heart icon">❤️</span></p>
